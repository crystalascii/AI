...
for i in range(total_models):
    model = Sequential()
    model.add(Dense(units=7, input_dim=3))
...
if load_saved_pool:
    for i in range(total_models):
        current_pool[i].load_weights("TrainedModels/Model_Pool_Trained1/model_new"+str(i)+".keras")
...
def mainGame(movementInfo):
    ...
    while True:
        ...
        '''
        print('score: ', score)
        print('state: ', playersState)
        print('y pos: ', playersYList)
        print('**************************************************************************')
...
def showGameOverScreen(crashInfo):
    ...
    print(current_pool[index].get_weights())
